...
const errorReasonKeys: Partial<Record<string, MessageKey>> = {
  ...
  SYSTEM_MEMBER_NOT_FOUND: "error.reason.systemMemberNotFound",
  SYSTEM_MEMBER_EXISTS: "error.reason.systemMemberExists",
  SYSTEM_MEMBER_REQUIRED: "error.reason.systemMemberRequired",
  ...
  INVALID_SYSTEM_CONFIG: "error.reason.invalidSystemConfig",
