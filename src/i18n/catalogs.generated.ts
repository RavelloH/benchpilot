...
export const catalogs = {
  en: {
    ...
    "screen.root.adapter":
      "Manage and diagnose device adapters (list, show, doctor...)",
    "screen.root.approval":
      "Manage human approvals in automated workflows (list, approve, reject...)",
    "screen.root.commonOptions": "Global options",
    "screen.root.config": "Manage global and project configuration files",
    ...
    "screen.root.lock":
      "Manage exclusive locks for physical resources (list, show, clear...)",
    ...
    "screen.root.run":
      "View operation records, logs, and artifacts (list, show, logs...)",
    "screen.root.setup": "Set up the project and local environment",
    "screen.root.skill": "View skills available to agents",
    "screen.root.workflow":
      "Manage and trigger automation workflows (list, run...)",
  },
  "zh-CN": {
    "cli.interaction.agent":
    ...
    "menu.value": "请输入{name}",
    "screen.root.adapter": "管理和诊断设备适配器 (list, show, doctor...)",
    "screen.root.approval":
      "管理自动化流程中的人工审批 (list, approve, reject...)",
    "screen.root.commonOptions": "全局选项",
    "screen.root.config": "管理全局与项目配置文件",
    ...
    "screen.root.lock": "管理物理资源的独占互斥锁 (list, show, clear...)",
    ...
    "screen.root.run": "查看操作记录、日志和执行产物 (list, show, logs...)",
    "screen.root.setup": "配置项目和本地环境",
    "screen.root.skill": "查看供 Agent 使用的技能说明",
    "screen.root.workflow": "管理和触发自动化工作流 (list, run...)",
  },
} as const;
