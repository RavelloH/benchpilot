...
export const catalogs = {
  en: {
    ...
    "menu.homeGuide":
      "Type to filter commands; use ↑↓ to navigate and Enter to select.",
    "menu.homeGuideTitle": "Interactive guide",
  ...
  "zh-CN": {
    ...
    "menu.homeGuide": "输入以筛选命令；使用 ↑↓ 选择，Enter 确认。",
    "menu.homeGuideTitle": "操作指引",
